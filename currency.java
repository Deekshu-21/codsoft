...
public class currency{
    public static void main(String[] args) {
        ...
        System.out.println(" Hey people!!!Welcome to Currency Converter!");
        System.out.println("1. USD to Rupee");
        System.out.println("2. Rupee to USD");
        System.out.println("3. Euro to Rupee");
        System.out.println("4. Rupee to Euro");
        System.out.print("Enter ur  choice (1 or 2 or 3 or 4): ");
        ...
        if (choice == 1) {
            ...
            System.out.println(" Sorry do check once as it was Invalid choice. Please select 1 or 2 or 3 or 4.");
        }
